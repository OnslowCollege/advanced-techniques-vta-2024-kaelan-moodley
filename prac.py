...
class Hero:
    ...
    def attack(self) -> int:
        ...
        """
        return random.randint(self.attack_power // 2, self.attack_power)  # Random damage within attack power range
...
class Player(Hero):
    ...
    def __init__(self, name: str):
        ...
        self.stats = {"battles_won": 0, "battles_lost": 0}  # Track battles won and lost
    ...
    def use_potion(self, potion_type: str, enemy: "Enemy"):
        ...
        """
        if self.inventory.get(potion_type, 0) > 0:  # Check if potion is available
...
class Enemy(Hero):
    ...
    def __init__(self, name: str, health: int, attack_power: int, reward: int, description: str):
        ...
        """
        super().__init__(name, health, attack_power)  # Initialize with given parameters
